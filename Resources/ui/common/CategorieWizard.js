function CategorieWizard(title) {
	...
	var viewWizard = Ti.UI.createView({
		backgroundColor : '#fff',
		bottom : 0,
		height : 60,
		width : 'auto'
	});
	var buttonWizard = Ti.UI.createButton({
		title : 'Prosegui',
		textAlign : 'center',
		color : '#fff',
	...
	self.add(viewWizard);
	self.add(buttonWizard);
	
	self.addEventListener('focus', function() {
    	flurry.onPageView();
    	tracker.trackScreen("Wizard");
	});
...
module.exports =  CategorieWizard;
